...
const Sidebar = ({ pageSetter }) => {
    ...
    return (
        <div className='Sidebar bg-gray-800 h-[100%] w-[30%] relative flex flex-col p-3 gap-3 text-white'>
            ...
            <button className='NoDrag w-[100%] bg-gray-700 hover:bg-gray-600 p-3 rounded-lg cursor-pointer transition-all duration-100 ease-linear relative flex justify-center items-center' onClick={() => { pageSetter(2) }}><GiCurvyKnife className='absolute left-3' />Skin Changer</button>
            <button className='NoDrag w-[100%] bg-gray-700 hover:bg-gray-600 p-3 rounded-lg cursor-pointer transition-all duration-100 ease-linear relative flex justify-center items-center' onClick={() => { pageSetter(3) }}><GoGear className='absolute left-3' />Settings</button>
